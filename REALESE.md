> RESPONSIVIDADE
    ...
    COMPETÊNCIAS
    . reestruturar os cards de certificados para retirar a barra de rolagem veritcal

    EVENTOS
    cards ruins

    sobre mim
    . card-versus, reconfigurar tamanho das fontes
    . centralizar texto, pois está sendo coberto ao lado direito
